...
class Api::V1::UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'create_success: should create user' do
    ...
    assert_difference('User.count', 1) do
      post api_v1_users_path,
           params: {user:{email:"succeed1@example.com", password_digest:"123456"}},
           as: :json
    end
    assert_response 201
  end
  ...
  test 'update_success: should update user' do
    put api_v1_user_path(@user),
         params: {user:{email:'test@example.com', password:'123456'}},
         as: :json
    assert_response 202
  end

  test 'destroy_success: should delete user' do
    assert_difference('User.count', -1) do
