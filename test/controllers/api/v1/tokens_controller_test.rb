...
class Api::V1::TokensControllerTest < ActionDispatch::IntegrationTest
  ...
  test"create success: create token with legal email and password" do
    post api_v1_tokens_path, params:{user:{email:@user_one.email, password_digest:"admin"}}, as: :json
    assert_response 201
  ...
  test "create fail: create token with legal email and illegal password" do
    post api_v1_tokens_path, params:{user:{email:@user_one.email, password_digest:"123"}},
         as: :json
    assert_response 401
  end
